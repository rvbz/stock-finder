...
<template>
    <Head title="Welcome" />
        <LandingMenu :canRegister="canRegister" :canLogin="canLogin"></LandingMenu>
            ...
            <Container>
                <div class="relative pt-36 ml-auto">
                    <div class="lg:w-2/3 text-center mx-auto">
                        <h1 class="text-gray-900 dark:text-white font-bold text-5xl md:text-6xl xl:text-7xl">Your stock trading <span class="text-indigo-600 dark:text-white">reimaginated.</span></h1>
                        ...
                        <div class="mt-16 flex flex-wrap justify-center gap-y-4 gap-x-6">
                            <Link
                                v-if="canRegister"
                                :href="route('register')"
                                class="relative flex h-11 w-full items-center justify-center px-6 before:absolute before:inset-0 before:rounded-full before:bg-primary before:transition before:duration-300 hover:before:scale-105 active:duration-75 active:before:scale-95 sm:w-max hover:bg-indigo-700 bg-indigo-600 rounded-full"
                            >
    ...
    <!-- <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center sm:pt-0">
        <div v-if="canLogin" class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
            ...
            <template v-else>
                <a href="#" @click.prevent="facebookLogin" class="text-sm text-gray-700 dark:text-gray-500 underline">Log in with Facebook</a>
