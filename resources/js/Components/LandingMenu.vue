	        ...
	        <div class="max-w-7xl mx-auto px-6 md:px-12 xl:px-6">
	            <div class="flex flex-wrap items-center justify-between py-2 gap-6 md:py-4 md:gap-0 relative">
	                ...
	                <div class="relative z-20 w-full flex justify-between lg:w-max md:px-0">
	                    <a href="#" aria-label="logo" class="flex space-x-2 items-center">
	                        <div aria-hidden="true" class="flex space-x-1">
	                            ...
	                            <div class="h-6 w-2 bg-indigo-800"></div>
	                        </div>
	                        <span class="text-2xl font-bold text-gray-900 dark:text-white">Tradeneus</span>
	                    </a>
	                ...
	                <div class="flex-col z-20 flex-wrap gap-6 p-8 rounded-3xl border border-gray-100 bg-white shadow-2xl shadow-gray-600/10 justify-end w-full invisible opacity-0 translate-y-1  absolute top-full left-0 transition-all duration-300 scale-95 origin-top 
	                    ...
	                    <div v-if="canLogin" class="text-gray-600 dark:text-gray-300 lg:pr-4 lg:w-auto w-full lg:pt-0">
	                        <ul class="tracking-wide font-medium lg:text-sm flex-col flex lg:flex-row gap-6 lg:gap-0">
	                            ...
	                            <template v-else>
	                            	<li>
	                            		<a href="#" @click.prevent="facebookLogin" class="text-sm text-gray-700 dark:text-gray-500">Log in with Facebook</a>
	                            	</li>

					                <Link :href="route('login')" class="ml-4 text-sm text-gray-700 dark:text-gray-500">Log in</Link>
					            </template>
	                        </ul>
	                    </div>
	                    ...
	                    <div class="mt-12 lg:mt-0">
	                        <Link
	                        	v-if="canRegister"
	                            :href="route('register')"
	                            class="relative flex h-9 w-full items-center justify-center px-4 before:absolute before:inset-0 before:rounded-full before:bg-indigo-600 before:transition before:duration-300 hover:before:scale-105 active:duration-75 active:before:scale-95 sm:w-max"
	                            >
